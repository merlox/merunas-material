...
<<<<<<< HEAD
    var opensslMajor = Number(process.versions.openssl.split('')[0]);
    if (opensslMajor <= 0) {
...
=======
    //PCI compliance
    if (semver.lt(process.versions.openssl.slice(0, 5), '1.0.1')) {
        console.warn('SECURITY WARNING: openssl version ' + process.versions.openssl + ' detected. Please upgrade to latest OpenSSL version to enable TLSv1.2.');
>>>>>>> internal/master
    }
